      ...
      <div className="w-1/2 flex flex-col justify-center px-12 lg:px-20 py-12" style={{ backgroundColor: '#ffffff' }}>
        <div className="w-full max-w-md mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button type="submit" className="w-full py-3.5 transition-all rounded-xl shadow-lg" style={{ background: 'linear-gradient(to right, #3b82f6, #4f46e5)', boxShadow: '0 10px 15px -3px rgba(59, 130, 246, 0.3)' }} loading={loading}>
          ...
          <div className="mt-8 text-center">
            <p style={{ color: '#6b7280' }}>
              ...
              <Link to="/login" className="font-medium transition-colors inline-flex items-center gap-1" style={{ color: '#2563eb' }}>
                Sign in
                <ArrowRight size={14} />
              </Link>
            </p>
